...
<body>
    ...
    $datauser = mysqli_query($koneksi, "SELECT * FROM user WHERE username = '$geti'");
        ...
        <div class="profile-card">
            <div class="profile-header">
                <div class="profile-info">
                    <h1><?php echo $fullnamedb; ?></h1>
                    <p class="profile-role"><?php echo $categorydb; ?></p>
                </div>
            </div>
            ...
            <div class="info-grid">
                <div class="info-item">
                    ...
                    <div class="info-value"><?php echo $usernamesession; ?></div>
                </div>

                <!--
                <div class="info-item">
                    <div class="info-label">Email</div>
                    <div class="info-value">herdo.saputra@email.com</div>
                </div>
                -->
                ...
                <div class="info-item">
                    ...
                    <div class="info-value">Oral Medicine & Pathology</div>
                </div>
                --> 
                ...
                <div class="info-item">
                    ...
                    <div class="info-value">RS Dental Care Indonesia</div>
                </div>
                -->
            ...
            <script>
                function editprofile(){
                    window.location.href = "editprofile.php?i=<?php echo $usernamesession; ?>";
                }  

                function changepin(){
                    window.location.href = "changepin.php?i=<?php echo $usernamesession; ?>";
                }    
            </script>
            ...
            <div class="button-group">
                <button onclick="changepin()" class="btn-edit">Change PIN</button>
            </div>
